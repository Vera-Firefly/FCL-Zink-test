...
void glfwDefaultWindowHints(void)
{
    ...
    _glfw.hints.context.source = (strcmp(getenv("LIBGL_NAME"), "libOSMesa_8.so") == 0 || strcmp(getenv("LIBGL_NAME"), "libOSMesa.so") == 0) ? GLFW_OSMESA_CONTEXT_API : GLFW_NATIVE_CONTEXT_API;
...
GLFWAPI void glfwWindowHint(int hint, int value)
{
    ...
    switch (hint)
    {
        ...
        case GLFW_CONTEXT_CREATION_API:
            _glfw.hints.context.source = (strcmp(getenv("LIBGL_NAME"), "libOSMesa_8.so") == 0 || strcmp(getenv("LIBGL_NAME"), "libOSMesa.so") == 0) ? GLFW_OSMESA_CONTEXT_API : value;
            return;
