...
#include "driver/nsbypass.h"
#include "gl/gl.h"

#ifdef ADRENO_POSSIBLE
static bool checkAdrenoGraphics() {
...
void* loadTurnipVulkan() {
    ...
    void* linkerhook = linker_ns_dlopen("libdriver.so", RTLD_LOCAL | RTLD_NOW);
    void* turnip_driver_handle = linker_ns_dlopen("libvulkan.adr.so", RTLD_LOCAL | RTLD_NOW);
    void (*linkerhook_set_data)(void*, void*, void*) = dlsym(linkerhook, "fcl_linkerhook_set_data");
